...
enum BottomNavigationBarV2Type {
...
enum BottomNavigationBarV2LandscapeLayout {
...
class BottomNavigationBarV2 extends StatefulWidget {
  ...
  @override
  State<BottomNavigationBarV2> createState() => _BottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (type) {
      case BottomNavigationBarV2Type.fixed:
        size = 1;
      case BottomNavigationBarV2Type.shifting:
...
class _BottomNavigationBarState extends State<BottomNavigationBarV2> with TickerProviderStateMixin {
  ...
  BottomNavigationBarV2Type get _effectiveType {
    return widget.type
        ?? BottomNavigationBarV2Theme.of(context).type
        ?? (widget.items.length <= 3 ? BottomNavigationBarV2Type.fixed : BottomNavigationBarV2Type.shifting);
  }
  ...
  @override
  void didUpdateWidget(BottomNavigationBarV2 oldWidget) {
    ...
    if (widget.currentIndex != oldWidget.currentIndex) {
      ...
      if (widget.currentIndex >= 0 && _backgroundColor != widget.items[widget.currentIndex].backgroundColor) {
        _backgroundColor = widget.items[widget.currentIndex].backgroundColor;
      }
    }
  }
...
class BottomNavigationBarV2Item extends BottomNavigationBarItem {
