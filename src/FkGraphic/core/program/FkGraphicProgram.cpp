...
uint32_t FkGraphicProgram::createShader(uint32_t type, std::string &shader) {
...
FkGraphicProgram *FkGraphicProgramAllocator::delegateAlloc(FkProgramDescription &desc) {
    ...
    switch (desc.type) {
        ...
        case FkProgramDescription::kType::PATH:
            ...
            break;
        case FkProgramDescription::kType::MATRIX_ANDROID:
            o = new FkGraphicAndroidMatProgram(desc);
            break;
        case FkProgramDescription::kType::YV12:
            o = new FkGraphicYUVProgram(desc);
            break;
    }
    if (o) {
        o->create();
