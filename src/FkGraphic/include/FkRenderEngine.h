...
public:
    ...
    FkResult updateMaterialWithSource(std::shared_ptr<FkMaterialCompo> &material, const std::shared_ptr<FkAbsImageSource> &source);
...
protected:
    ...
    FkResult _onUpdateMaterialWithSource(const std::shared_ptr<FkMessage> &msg);
